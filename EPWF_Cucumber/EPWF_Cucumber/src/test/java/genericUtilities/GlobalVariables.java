...
public class GlobalVariables {
	...
	public static String folderToZip = "/target/Reports/Screenshot";
	public static String zipName = "/target/Reports/Screenshot.zip";
	public static String tcSheetName="TestCases";
	public static String envAndDBSheetName="EnvironmentAndDB";
	public static String cardNumSheetNameForIPS ="CreditCardNumber";
	...
	public static String TokenServiceURL="ServiceURL";
	...
	public static final String tagConvenienceFeeAmt="xs|ConvenienceFeeAmt";
	public static final String tagTotalTaxAmt="xs|TotalTaxAmt";
	public static final String tagPaymentAmt="xs|PaymentAmt";
	...
	public static String ConvenienceFeeAmt;
	public static String TotalTaxAmt;
	public static String PaymentAmt;
	//for Multi Payment
	public static String SessionId;
	public static String PaymentVerificationTranId;
	...
	public String colInputChannelID="InputChannel";
	...
	public static String getURI="TOKENURL";
	...
	public static String ex_UserId;
	public static String ex_TokenId;
	...
	public static ArrayList<String> ex_QportalDestAppId= new ArrayList<String>();
	...
	//xml tags variable
	public static final String tagBTN="BillingAcctId";
	public static final String tagBillingAcctId="BillingAccntId";
	public static final String tagBillingAccntId="xs:BillingAccntId";
	public static final String tagBillngAccntId="ns2:BillingAccntId";
	...
	public static final String tagVendorPayment="VendorPaymentId";
	public static final String tagPaymentID_REfund="xs:OriginalPaymentId";
	public static final String tagPaymentAmt_REfund="xs:RefundPaymentAmt";
	public static final String tagConvenienceFeeAmt_REfund="xs:ConvenienceFeeAmt";
	public static final String tagTotalTaxAmt_REfund="xs:TotalTaxAmtt";
	public static final String tagWalletRef="ns2:WalletRef";
	public static final String tagPaymentInstrumentReferenceId="ns2:PaymentInstrumentReferenceId";
	public static final String tagBAID ="BillingApplicationId";
	public static final String tagUserID="UserId";
	public static final String tagInputChannel_Marlie="InputChannelId";
	public static final String tagCustomerType_Marlie="CustomerType";
	public static final String tagPaymentMethodCode="PaymentMethodCode";
	...
	//MultiPayment Response tags
	public static final String mul_SessionIdTag="xs|SessionId";
	public static final String mul_PaymentVerificationTranIdTag = "xs|PaymentVerificationTranId";
	...
	public static final String multiPaymentStatusQuery = "select payment_status_cd from payment where PAYMENT_ID='";
	...
	public static final String recordStatusQuery = "select record_status_cd from enrollment_request where BILLING_APPLICATION_ACCNT_ID = '";
	public static final String serviceactionQuery="select service_action_cd from enrollment_request where BILLING_APPLICATION_ACCNT_ID ='";
